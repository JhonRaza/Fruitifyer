import { View, Text, StyleSheet, Dimensions, Alert, Image, TextInput, TouchableOpacity, Button, ActivityIndicator } from 'react-native'
  ...
  const register = () => {
    if (email === '' && password === '') {
      ...
      auth().createUserWithEmailAndPassword(email, password).then((res) => {
          ...
          setLoading(false)
          setLogged(true)
          props.navigation.navigate('Base', {name: name})
      ...
      >
        ...
        <View style={styles.innerCard}>
          <View style={{ alignSelf: 'center', alignContent: 'center' }}>
            <Text style={{ fontFamily: 'Poppins-SemiBold', fontSize: 23, color: 'black', marginTop: 10, marginLeft: 0, paddingBottom: 30 }}>Create an account</Text>
          </View>
          ...
          <View style={{ flexDirection: 'row', justifyContent: 'center', marginTop: 7 }}>
            <TouchableOpacity onPress={register} style={styles.SignUp}>
              <Text style={{ color: 'white', fontFamily: 'Poppins-Regular', fontSize: 20 }}>Sign Up</Text>
            </TouchableOpacity></View>
          <View style={{ flexDirection: 'row', justifyContent: 'center', marginTop: 10 }}>

            <Text style={{ color: '#a1a1a1', fontFamily: 'Poppins-Regular', fontSize: 13 }}>Already have an account? </Text>
            <TouchableOpacity onPress={() => { props.navigation.navigate('Log In') }}>
              <Text style={{ color: 'rgba(118, 52, 170, 1)', fontFamily: 'Poppins-Medium', textDecorationLine: 'underline', fontSize: 13 }}>Log in!</Text>
            </TouchableOpacity></View>
        </View>
      </LinearGradient>
    )
